...
fn make_cbox_scene() -> SimpleVtraceScene {
  let root_obj = Rc::new(SpaceObj::new(Rc::new(VacuumVolumeMatDef::default())));
  //let root_obj = Rc::new(SpaceObj::new(Rc::new(HomogeneousDielectricVolumeMatDef::default_hg(0.0025, 0.9))));
  ...
  let leftwall_obj = Rc::new(QuadObj::new(vec![
      ...
      Vector3::new(-1.0, 0.00, -1.0),
      Vector3::new(-1.0, 0.00, 1.0),
      Vector3::new(-1.0, 1.58, -1.0),
      Vector3::new(-1.0, 1.58, 1.0),
  //], Rc::new(PassThroughSurfaceMatDef::default())));
  ], Rc::new(LambertianSurfaceMatDef{absorb_prob: 0.0})));
  ...
  let backwall_obj = Rc::new(QuadObj::new(vec![
      /*Vector3::new(-1.02, 0.0, -1.04),
      Vector3::new(1.0, 0.0, -1.04),
      Vector3::new(-1.02, 1.59, -1.04),
      Vector3::new(1.0, 1.59, -1.04),*/
      Vector3::new(-1.0, 0.0, -1.0),
...
fn main() {
  ...
  let render_opts = RenderOpts{
    ...
    cam_origin: Vector3::new(0.0, 0.8, 5.4),
    cam_lookat: Vector3::new(0.0, 0.8, 4.4),
